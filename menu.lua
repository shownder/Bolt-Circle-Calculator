    ...
    if i == 3 then
      ...
      if (string.sub(system.getInfo("model"),1,2) == "iP") then
        ...
        if tonumber(version) >= 7.1 then
          system.openURL("http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?id=738116241&pageNumber=0&sortOrdering=2&type=Purple+Software&mt=8")
        else
...
local function transactionCallback( event )
   ...
   if  tstate == "restored" then
      ...
      if "com.bolt.iap.sine" == product then
        storeSettings.sinePaid = true
      elseif "com.bolt.iap.speed" == product then
        storeSettings.speedPaid = true
      elseif "com.bolt.iap.trig" == product then
...
--  storeSettings.boltPaid = true
  ...
  butTable[8] = "Images/sineMenu.png"
  butTable[1] = "Images/boltMenu.png"
  ...
  labelTable[8] = "Sine Bar"
  labelTable[1] = "Bolt Circle"
